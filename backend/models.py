...
class ObjektType(str, Enum):
    """Object type for zaposlenik permissions"""
    RESTORAN = "restoran"
    APARTMAN = "apartman"
...
class Rezervacija(TimestampMixin, CreatorMixin):
    ...
    status: str = Field(default="na_čekanju", description="Reservation status")
    napomena: Optional[str] = None
...
class ZaposlenikObjekt(BaseModel):
    """
    Zaposlenik object permissions
    Defines which objects (restorani/apartmani) a zaposlenik can access
    """
    id: Optional[int] = None
    zaposlenik_id: int = Field(..., description="Zaposlenik ID")
    objekt_type: ObjektType = Field(..., description="Object type (restoran/apartman)")
    objekt_id: int = Field(..., description="Object ID (restoran_id or apartman_id)")
    can_view: bool = Field(default=True, description="Can view")
    can_edit: bool = Field(default=True, description="Can edit")
    can_create: bool = Field(default=True, description="Can create reservations")
...
class SystemData(BaseModel):
    ...
    moduli: list[Modul] = []
    vlasnik_moduli: list[VlasnikModul] = []
    zaposlenik_objekti: list[ZaposlenikObjekt] = []  # ← NOVO!
